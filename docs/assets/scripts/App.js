...
window.onload = function () {
    ...
    var circles = new _Circles2.default();
    ...
    var passInputValues = function passInputValues(value, keyData) {
        // pass value to calc
...
var Calculator = function () {
    ...
    _createClass(Calculator, [{
        ...
        value: function events() {
            ...
            this.historyList.addEventListener('click', function (event) {
                if (event.target.dataset.answer) {
                    _this.setHistoricValue(event.target.dataset.answer);
                }
            });
        }
    }, {
        ...
        key: 'addHistoryListItem',
        value: function addHistoryListItem(input) {
...
var Circles = function () {
    ...
    _createClass(Circles, [{
        ...
        key: 'drawCircle',
        value: function drawCircle(point, color) {
            // create a new circle, set radius based on use of mobile device or not
            var newCircle = new Path.Circle(point, this.setResponsively(300, 500));
        ...
        value: function setCirclestoDraw(value) {
            ...
            var MAX_CIRCLES_TO_DRAW = this.setResponsively(100, 250);
